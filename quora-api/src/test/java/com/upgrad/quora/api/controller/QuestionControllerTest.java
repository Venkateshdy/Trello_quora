...
public class QuestionControllerTest {
    ...
    // This test case passes when you try to create the question but the JWT token entered does not
    // exist in the database.
    @Test
    public void createQuestionWithNonExistingAccessToken() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.post ("/question/create?content=my_question")
    ...
    // This test case passes when you try to create the question but the user corresponding to the JWT
    // token entered is signed out of the application.
    @Test
    ...
    // This test case passes when you try to get the detail of all the questions and the JWT token
    // entered exists in the database and the user corresponding to that JWT token is signed in.
    @Test
    public void getAllQuestions() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.get ("/question/all")
                        .header ("authorization", "database_accesstoken1"))
                .andExpect (status ().isOk ());
    }

    // This test case passes when you try to get the detail of all the questions but the JWT token
    ...
    // This test case passes when you try to get the detail of all the questions and the JWT token
    // entered exists in the database but the user corresponding to that JWT token is signed out.
    @Test
    ...
    // This test case passes when you try to edit the question but the JWT token entered does not
    // exist in the database.
    @Test
    public void editQuestionWithNonExistingAccessToken() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.put (
                        "/question/edit/database_question_uuid?content=edited_question")
                        .contentType (MediaType.APPLICATION_JSON_UTF8_VALUE)
                        .header ("authorization", "non_existing_access_token"))
                .andExpect (status ().isForbidden ())
                .andExpect (MockMvcResultMatchers.jsonPath ("code").value ("ATHR-001"));
    ...
    // This test case passes when you try to edit the question and the JWT token entered exists in the
    // database but the user corresponding to that JWT token is signed out.
    @Test
    ...
    public void editQuestionWithoutOwnership() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.put (
                        "/question/edit/database_question_uuid?content=edited_question")
                        .contentType (MediaType.APPLICATION_JSON_UTF8_VALUE)
                        .header ("authorization", "database_accesstoken"))
                .andExpect (status ().isForbidden ())
    ...
    public void editNonExistingQuestion() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.put (
                        "/question/edit/non_exisitng_question_uuid?content=edited_question")
                        .contentType (MediaType.APPLICATION_JSON_UTF8_VALUE)
                        .header ("authorization", "database_accesstoken1"))
    ...
    public void getAllQuestionsByUserWithNonExistingAccessToken() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.get ("/question/all/database_uuid1")
                        .header ("authorization", "non_existing_access_token"))
                .andExpect (status ().isForbidden ())
                .andExpect (MockMvcResultMatchers.jsonPath ("code").value ("ATHR-001"));
    }

    // This test case passes when you try to get all the questions posted by a specific user and the
    // JWT token entered exists in the database but the user corresponding to that JWT token is signed
    // out.
    @Test
    ...
    // This test case passes when you try to get all the questions posted by a specific user which
    // does not exist in the database.
    @Test
    public void getAllQuestionsForNonExistingUser() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.get ("/question/all/non_existing_user_uuid")
                        .header ("authorization", "database_accesstoken1"))
                .andExpect (status ().isNotFound ())
