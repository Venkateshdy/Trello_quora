...
public class AnswerControllerTest {
    ...
    // This test case passes when you try to create the answer but the JWT token entered does not
    // exist in the database.
    @Test
    public void createAnswerWithNonExistingAccessToken() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.post (
                        "/question/database_question_uuid/answer/create?answer=my_answer")
    ...
    // This test case passes when you try to create the answer but the user corresponding to the JWT
    ...
    // This test case passes when you try to create the answer for the question which does not exist
    // in the database.
    @Test
    public void createAnswerForNonExistingQuestion() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.post (
                        "/question/non_existing_question_uuid/answer/create?answer=my_answer")
                        .contentType (MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    // This test case passes when you try to edit the answer but the JWT token entered does not exist
    // in the database.
    @Test
    ...
    public void editNonExistingAnswer() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.put (
                        "/answer/edit/non_existing_answer_uuid?content=edited_answer")
                        .contentType (MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    // This test case passes when you try to delete the answer but the JWT token entered does not
    // exist in the database.
    @Test
    ...
    // This test case passes when you try to get all the answers posted for a specific question but
    // the JWT token entered does not exist in the database.
    @Test
    public void getAllAnswersToQuestionWithNonExistingAccessToken() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.get ("/answer/all/database_question_uuid")
                        .header ("authorization", "non_existing_access_token"))
                .andExpect (status ().isForbidden ())
                .andExpect (MockMvcResultMatchers.jsonPath ("code").value ("ATHR-001"));
    }

    // This test case passes when you try to get all the answers posted for a specific question and
    // the JWT token entered exists in the database but the user corresponding to that JWT token is
    // signed out.
    @Test
    ...
    // This test case passes when you try to get all the answers posted for a specific question which
    // does not exist in the database.
    @Test
    public void getAllAnswersToNonExistingQuestion() throws Exception {
        mvc.perform (
                MockMvcRequestBuilders.get ("/answer/all/non_existing_question_uuid")
                        .header ("authorization", "database_accesstoken"))
                .andExpect (status ().isNotFound ())
                .andExpect (MockMvcResultMatchers.jsonPath ("code").value ("QUES-001"));
    }
